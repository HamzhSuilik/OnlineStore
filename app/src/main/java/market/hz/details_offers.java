...
import market.hz.connection.details_offers_connection;
import market.hz.function.save_favorite_offers;


public class details_offers extends AppCompatActivity {
    ...
    details_offers_connection detailsConnection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save_favorite_offers favorite=new save_favorite_offers(Integer.valueOf(row),getApplicationContext());
        if(favorite.check()!=0){
            favorite_check=true;
        ...
        detailsConnection =new details_offers_connection(this,row,text_array,image_array,layout_array,imageSlider,viewPager);
    ...
    public void favorite(View view){
        ...
        if(gg.getInt("change_offers",0)==0) {
            copy.putInt("change_offers", 1);
            copy.apply();
        }else{
            copy.putInt("change_offers", 0);
            copy.apply();
        }
