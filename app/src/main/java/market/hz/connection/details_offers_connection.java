...
public class details_offers_connection {
    ...
    public details_offers_connection(Context c, String row, final ArrayList<TextView> arrayList, final ArrayList<ImageView> arrayList_image, final ArrayList<LinearLayout> arrayList_layout
    ...
    public void retrieve(final ProgressBar myProgressBar)
    {
        ...
        AndroidNetworking.get(PHP_MYSQL_SITE_URL)
                ...
                .addHeaders("task","details_offers")
                .addHeaders("row",row)
    ...
    private void image_downloader_1(ArrayList<String>image){
            ...
            for (int i = 9; i >= 0; i--) {
                ...
                if (image.get(i) != "null") {
                    num_image1++;
                    String url = url_http+"/app/all_image/offers/"+row+"/" + image.get(i);
        ...
        String path=url_http+"/app/all_image/offers/"+row+"/" + image.get(0);
